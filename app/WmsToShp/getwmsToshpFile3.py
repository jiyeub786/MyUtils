...
wfs = WebMapService(url=url)

params = dict(service='wms', version='1.3.0', typeName='A2SM_FLOODFOVRRISK',
              request='GetMap', outputFormat='application/json')
...
data.to_file('A2SM_FLOODFOVRRISK.shp', driver='ESRI Shapefile', encoding='utf-8' )
#########################
